...
// const Carditem = ({ title, image, link, tools }) => {
//   return (
//     <div className="h-[20em] w-[20em] border-2 border-[rgba(75,30,133,0.5)] rounded-[1.5em] bg-gradient-to-br from-[rgba(75,30,133,1)] to-[rgba(75,30,133,0.01)] text-white font-nunito p-[1em] flex flex-col justify-between items-center gap-[0.75em] backdrop-blur-[12px] transition-transform transform hover:scale-105 duration-300">
//       <div className="flex flex-col items-center">
//         <h1 className="text-[1.5em] font-medium text-center">{title}</h1>
//         <img
//           src={image}
//           alt={title}
...
//           <span
//             key={index}
//             className="bg-white text-black rounded-full px-2 py-1 text-xs font-semibold"
//           >
//             {tool}
//           </span>
//         ))}
